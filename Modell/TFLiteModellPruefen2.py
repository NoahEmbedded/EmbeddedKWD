...
#Teste Noise
print("\n\ninput = Noise (",len(liste_daten_noise)," Samples)")
marvin50 = 0
marvin70 = 0
marvin90 = 0
noise50 = 0
...
for noise in liste_daten_noise:
    print(round(100*(zaehler/len(liste_daten_noise)),1)," Prozent verarbeitet            ",end="\r")
    zaehler+=1
...
#Teste Marvin
print("\n\ninput = marvin(",len(liste_daten_marvin)," Samples)")
marvin50 = 0
marvin70 = 0
marvin90 = 0
noise50 = 0
...
for marvin in liste_daten_marvin:
    print(round(100*(zaehler/len(liste_daten_marvin)),1)," Prozent verarbeitet            ",end="\r")
    zaehler+=1
    ...
    if(ergebnis[0][2]>=0.9):
        ruhe90+=1
print("Marvin fertig                        ",end="\n")
print("Marvin erkannt(50%,70%,90%):",marvin50,marvin70,marvin90)
print("noise erkannt(50%,70%,90%):",noise50,noise70,noise90)
print("ruhe erkannt(50%,70%,90%):",ruhe50,ruhe70,ruhe90)
#Teste Ruhe
print("\n\ninput = ruhe(",len(liste_daten_ruhe)," Samples)")
marvin50 = 0
marvin70 = 0
marvin90 = 0
noise50 = 0
...
for ruhe in liste_daten_ruhe:
    print(round(100*(zaehler/len(liste_daten_ruhe)),1)," Prozent verarbeitet            ",end="\r")
    zaehler+=1
