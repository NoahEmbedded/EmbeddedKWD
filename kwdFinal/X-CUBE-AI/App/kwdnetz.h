...
#ifndef __AI_KWDNETZ_H__
#define __AI_KWDNETZ_H__
#pragma once

#include "ai_platform.h"

#define AI_KWDNETZ_MODEL_NAME          "kwdnetz"

#define AI_KWDNETZ_IN_NUM       (1)
#define AI_KWDNETZ_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 62, 256, 1, 1, NULL), \
}
#define AI_KWDNETZ_IN_SIZE { \
  (62 * 256 * 1), \
}
#define AI_KWDNETZ_IN_1_SIZE  (62 * 256 * 1)
#define AI_KWDNETZ_IN_1_SIZE_BYTES  ((62 * 256 * 1) * 4)


#define AI_KWDNETZ_OUT_NUM      (1)
#define AI_KWDNETZ_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_KWDNETZ_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_KWDNETZ_OUT_1_SIZE  (1 * 1 * 3)
#define AI_KWDNETZ_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)
 ...
 * @ref ai_kwdnetz_create. Both the activations memory buffer 
 ...
 * using @ref ai_kwdnetz_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_KWDNETZ_*
 * defines into file @ref kwdnetz.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_kwdnetz_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_KWDNETZ_H__*/
